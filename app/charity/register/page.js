      ...
      <div className="mx-auto p-10" style={{ maxWidth: "900px" }}>
        <form>
          ...
          <div className="mt-10">
            ...
            <p className="text-sm">
              Please select the ways in which you'd like to participate. Choose
              at least one.
            </p>
          </div>
          ...
          <div className="mt-10">
            ...
            <p className="text-sm">
              Please select the ways in which you'd like to sponsor. Choose at
              least one.
            </p>
          </div>
          <div className="ml-4 mt-4">
          ...
          <div className="my-10 text-end">
            <span className="font-bold">Your Total Cost:</span> $
            {total.toFixed(2)}
          </div>
